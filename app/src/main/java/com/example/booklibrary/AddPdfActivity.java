...
public class AddPdfActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(title)) {
            Toast.makeText(this, "Внеси наслов", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(description)) {
            Toast.makeText(this, "Внеси краток опис", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(category)) {
            Toast.makeText(this, "Одбери категорија", Toast.LENGTH_SHORT).show();
        } else if (pdfUri == null) {
            Toast.makeText(this, "Прикачи PDF", Toast.LENGTH_SHORT).show();
        } else {
            uploadPdfToStorage();
        }
    }
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddPdfActivity.this, "Успешно прикачено", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
